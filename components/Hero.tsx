export default function Hero() {
  return <section className="hero-grid relative overflow-hidden px-5 pb-20 pt-12 text-center sm:pb-28 sm:pt-20">
    ...
    <div className="relative mx-auto max-w-4xl"><span className="eyebrow">AI Marketing Expert · Free one-to-one consultation</span>
      <h1 className="mt-6 text-4xl font-extrabold leading-[1.08] tracking-tight text-white sm:text-6xl">Get a Free <span className="text-blue-300">AI-Powered Marketing Plan</span> to Help Your Business Attract More Customers Online</h1>
      ...
      <a href="#consultation-form" className="mt-9 inline-flex min-h-14 items-center justify-center rounded-full bg-blue px-7 text-base font-bold text-white shadow-lg shadow-blue-500/25 transition hover:-translate-y-0.5 hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-200">Book Free Consultation <span aria-hidden className="ml-2">→</span></a>
